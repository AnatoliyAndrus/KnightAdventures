...
public class RoomManager {
    ...
    public void setGameObjects() {
        //RUINS
        rooms.get("ruins").addGameObject(new WoodenBox(gp), gp.squareSize * 8 + 10, gp.squareSize * 5);
        ...
        rooms.get("ruins").addGameObject(new WoodenBox(gp), gp.squareSize * 15 + 20, gp.squareSize * 5);
        rooms.get("ruins").addGameObject(new WoodenBox(gp), gp.squareSize * 16, gp.squareSize * 5 + 38);
